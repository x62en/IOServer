...
(function() {
  ...
  var AccessMiddleware, HOST, IOServer, PORT, PrivateMiddleware, PrivateService, RegistrationService, SessionManager, StandardService, app, end_point, opts, should, socketio_client;
